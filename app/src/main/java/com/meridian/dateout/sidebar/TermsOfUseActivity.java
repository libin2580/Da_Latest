...
LinearLayout back;
    ...
    public static TermsOfUseActivity newInstance() {
      TermsOfUseActivity fragment = new TermsOfUseActivity();
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      // FrameLayoutActivity.img_toolbar_crcname.setText("TERMS OF USE");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_termsof_use, container, false);
        ...
        toolbarname= (TextView) view.findViewById(R.id.toolbar_CRCNAM);
        toolbarname.setText("TERMS OF USE");
