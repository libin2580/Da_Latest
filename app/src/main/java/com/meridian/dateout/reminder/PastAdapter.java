...
/**
 * Created by user1 on 30-Nov-17.
 */

public class PastAdapter extends RecyclerView.Adapter<PastAdapter.ViewHolder> {

    ArrayList<PastModel> arrayList=new ArrayList<>();
    Context context;
    int row_index;
    public PastAdapter(ArrayList<PastModel> array_up, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        System.out.println("pastttttttttttttttttttttttttttttt"+arrayList.size()+"......."+arrayList);
    }
