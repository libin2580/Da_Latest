    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        condtiion_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(Adddetails.this,TermsOfUse.class);
                startActivity(i);
            }
        });
...
*/
        ...
        final LayoutInflater inflator = (LayoutInflater) Adddetails.this.getSystemService(LAYOUT_INFLATER_SERVICE);
        ...
        save_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Adddetails.this.isFinishing()) {
