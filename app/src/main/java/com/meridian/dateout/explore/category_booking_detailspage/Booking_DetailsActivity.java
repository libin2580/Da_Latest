...
public class Booking_DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("price") != null) {
            child_tkt_price = getIntent().getStringExtra("price");
        ...
        try {
            if (deal_type.contentEquals("gifts") || deal_type.contentEquals("food_and_beverages")||deal_type.contentEquals("")||deal_type.contentEquals("services")) {
...
if(delivery_adrs_required.equalsIgnoreCase("yes")) {
    ...
    if (booking_date == "" && calendar_show.contentEquals("yes")) {
        ...
        if (deal_type.contentEquals("gifts") || deal_type.contentEquals("food_and_beverages")) {
            ...
            final SweetAlertDialog dialog = new SweetAlertDialog(Booking_DetailsActivity.this, SweetAlertDialog.NORMAL_TYPE);
            dialog.setTitleText("")
                    .setContentText("Please select the quantity")
                    .setConfirmText("OK")
                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        @Override
                        public void onClick(SweetAlertDialog sDialog) {
        ...
        if (userid != null) {
            ...
            params = new ArrayList<Pair<String, String>>() {{
                ...
                add(new Pair<String, String>("address_id", ""));
