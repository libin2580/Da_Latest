...
public class EarnedPointsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    ...
    public EarnedPointsAdapter(Context context, ArrayList<String>  namess,ArrayList<String> pointss,ArrayList<String> dateArraylist) {
