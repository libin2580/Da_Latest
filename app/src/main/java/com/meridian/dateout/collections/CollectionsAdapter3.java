...
public class CollectionsAdapter3  extends RecyclerView.Adapter<CollectionsAdapter3.ViewHolder> {
    ...
    public CollectionsAdapter3(List<DealsModel> dealsModelArrayList1, Context context) {
    ...
    {
        CollectionsFragment.recyclerView_search.setVisibility(View.VISIBLE);
        CollectionsFragment.recyclerView.setVisibility(View.GONE);
