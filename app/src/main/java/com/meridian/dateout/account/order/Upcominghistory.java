 ...
 */
public class Upcominghistory extends Fragment {
    ...
    public static Upcominghistory newInstance() {
        Upcominghistory fragment = new Upcominghistory();
    ...
    private class getOrderHistory extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String jsonStr = sh.makeServiceCall(Constants.URL+"order_history.php?user_id="+userid);
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                            ...
                            String bookingdate=obj.getString("booking_date");

                            Date c = Calendar.getInstance().getTime();
                            SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");
                            String formattedDate = df.format(c);

                            Log.e("sssssssss",bookingdate);
                            Log.e("sssssssss",formattedDate);


                            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                            try {
                                date1 = sdf.parse(bookingdate);
                            ...
                            if(date1.after(date2) || date1.equals(date2))
                            {
                                ...
                                Log.e("sssssssss","The date is future day");
                          ...
                          else  if(OrderHistoryArraylist.isEmpty())
                            {
                               ...
                               /* System.out.println("The date is older than current day");
                                Log.e("sssssssss","The date is older than current day");
*/
                               /* getActivity().runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
